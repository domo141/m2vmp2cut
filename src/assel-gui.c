 ...
 * Last modified: Wed 07 Nov 2012 18:12:00 EET too
 */
...
const char * helptext =
    ...
    ".\n\n"
    "If there are more than one audio file, audio level scanning is not done "
    "yet\n" "The first one in list below will be scanned in this case.\n\n"
